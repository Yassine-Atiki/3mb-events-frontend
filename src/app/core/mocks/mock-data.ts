...
export const mockUsers: User[] = [
  {
    id: 'usr-participant',
    email: 'participant@3mb.com',
    firstName: 'Sara',
    lastName: 'El Amrani',
    role: 'PARTICIPANT',
    status: 'ACTIVE',
    phone: '+212 6 12 34 56 78',
    avatarUrl: 'https://i.pravatar.cc/150?u=participant@3mb.com',
